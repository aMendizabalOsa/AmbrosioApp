...
<script>
const AGENT_ORDER  = ["GmailReadAgent","GmailSendAgent","CalendarAgent","ReminderAgent","MarineAgent","TadoAgent","TapoAgent","TradeRepublicAgent","MyInvestorAgent"];
const AGENT_LABELS = {
